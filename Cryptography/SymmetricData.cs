...
namespace Sidub.Platform.Cryptography
{
    ...
    /// <summary>
    /// Represents symmetric data used in cryptography operations.
    /// </summary>
    public class SymmetricData
    {
        ...
        /// <summary>
        /// Gets or sets the initialization vector (IV) used in the encryption algorithm.
        /// </summary>
        public byte[] InitializationVector { get; set; } = Array.Empty<byte>();

        /// <summary>
        /// Gets or sets the cipher text resulting from the encryption operation.
        /// </summary>
