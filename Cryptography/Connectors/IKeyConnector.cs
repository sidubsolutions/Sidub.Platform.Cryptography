...
namespace Sidub.Platform.Cryptography.Connectors
{
    ...
    public interface IKeyConnector : IServiceMetadata
    {

    }

    public interface IKeyConnector<TCryptographyProvider> : IKeyConnector where TCryptographyProvider : ICryptographyProvider
    {
